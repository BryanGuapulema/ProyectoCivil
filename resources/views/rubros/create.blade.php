                ...
                <div class="p-6 sm:px-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <form method="POST" action="#">
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="nombre" type="text" name="nombre" required class="mt-1 block w-full dark:bg-gray-900 dark:text-gray-300"/>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-input id="categoria" type="text" name="categoria" required class="mt-1 block w-full dark:bg-gray-900 dark:text-gray-300"/>
                        </div>
                        
                        <div class="mb-4">
                            <x-label for="nro_personas" value="{{ __('Nro de personas') }}" class="text-gray-700 dark:text-gray-300"/>
                            <x-input id="nro_personas" type="number" step="1" name="nro_personas" required class="mt-1 block w-full dark:bg-gray-900 dark:text-gray-300"/>
                        </div>
