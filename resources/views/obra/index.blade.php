                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($obras as $obra)
                            <div class="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-6 flex flex-col justify-between">
                                <div class="mb-4">
                                    <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">{{ $obra->nombre_de_obra }}</h3>
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300 mb-2"><strong>Nombre Estudiante:</strong> {{ $obra->nombre_estudiante }}</p>
